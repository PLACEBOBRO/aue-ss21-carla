# Library function to start situation blinkingRed
# TODO: Move Waypoint (unreliable) or just trigger a couple of seconds before 
...
def start(world,client,traffic_manager):
    print("lib:Starting Situation blinkingRed")
    batch = []
    ...
    car_bp = random.choice(blueprints.filter("vehicle.mini.cooperst"))
    ...
    batch.append(SpawnActor(car_bp, spawn_points[241])
