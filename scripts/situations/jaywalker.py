...
def start(world):
    ...
    # Spawn_Point: Edited spawn_points[209] towards sidewalk
    spawn_point = carla.Transform(carla.Location(x=70, y=-79.507767, z=8.305596), carla.Rotation(pitch=0.000000, yaw=-87.975883, roll=0.000000))
